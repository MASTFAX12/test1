...
const NavButton: React.FC<{
  ...
  return (
    <button
      onClick={onClick}
      className={`w-full relative flex items-center gap-3 text-right px-3 py-3 rounded-lg text-sm font-semibold transition-all duration-200 ${
        isActive
