...
export const PaintBrushIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.983 4.346a2.25 2.25 0 00-3.182 0l-1.833 1.833a2.25 2.25 0 000 3.182l5.44 5.439a2.25 2.25 0 003.182 0l1.833-1.833a2.25 2.25 0 000-3.182l-5.44-5.44z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 12.75l.44-1.875a3.375 3.375 0 00-3.375-3.375l-1.875.44M14.25 12.75l-1.5-1.5" />
    </svg>
);
...
export const BuildingOffice2Icon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12.793V21M15 5.25v15.75M9 8.25v12.75M3 12.793V21m18 0h-6M9 21H3m18 0h-6M9 21H3m18 0v-6.207c0-.963-.39-1.858-1.025-2.525l-2.025-2.025c-.635-.635-1.562-1.025-2.525-1.025H9.05c-.963 0-1.858.39-2.525 1.025L4.5 9.243c-.635.635-1.025 1.562-1.025 2.525V21" />
    </svg>
);
